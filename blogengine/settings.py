...
if os.getenv('SERVER_SOFTWARE', '').startswith('Google App Engine'):
    ...
    DATABASES = {
        'default': {
            ...
            'HOST': '/cloudsql/flocationstestblog:usblogdb',
            'NAME': 'flocationstestblog',
            'USER': 'root',
        }
    }
    ...
    DATABASES = {
        'default': {
            ...
            'INSTANCE': 'flocationstestblog:usblogdb',
            'NAME': 'flocationstestblog',
            'USER': 'root',
        }
    }
...
ALLOWED_HOSTS = ['localhost', 'flocationstestblog.appspot.com']
...
STATIC_ROOT = os.path.join(BASE_URL, 'static_root')
...
SECRET_KEY = '40*#bywg_8l#gx#g+9*2x+8*kuq@*w*s+85%*-j*rrsm8!b%2o'
